...
gst-launch-1.0 -v udpsrc port=43000  ! application/x-rtp, media=audio,clock-rate=48000,payload=96,encoding-name=X-GST-OPUS-DRAFT-SPITTKA-00  ! rtpopusdepay  ! opusdec ! alsasink
...
gst-launch-1.0 -v tcpclientsrc host=localhost port=43000  ! application/x-rtp, media=audio, clock-rate=48000,payload=96 ! rtpopusdepay  ! opusdec ! alsasink

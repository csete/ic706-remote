...
gst-launch-1.0 -v alsasrc device=hw:1 ! 
    ...
    tcpserversink host=localhost port=43000

gst-launch-1.0 -v tcpclientsrc host=localhost port=43000 ! \
    audio/x-raw, format=S16LE, channels=1, rate=48000 ! \
    alsasink device=hw:1 sync=false
...
gst-launch-1.0 -v alsasrc device=hw:1 ! \
    ...
    rtpopuspay ! udpsink host=localhost port=43000

gst-launch-1.0 -v udpsrc port=43000 ! \
...
gst-launch-1.0 -v alsasrc device=hw:1 ! \
    ...
    opusenc bandwidth=1102 bitrate=12000 frame-size=60 complexity=5 ! \
    rtpopuspay ! tcpserversink host=localhost port=43000
